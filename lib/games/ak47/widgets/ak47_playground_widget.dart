...
class Ak47PlayedCardsWidget extends HookConsumerWidget {
  const Ak47PlayedCardsWidget({
    super.key,
...
class Ak47DeckWidget extends HookConsumerWidget {
  const Ak47DeckWidget({super.key, required this.deck});
