...
class Ak47PlayerModel extends PlayerModel {
  ...
  factory Ak47PlayerModel.fromProfile(ProfileModel profile) {
    return Ak47PlayerModel(
      id: profile.id,
  ...
  factory Ak47PlayerModel.fromMap(Map<String, dynamic> map) {
    return Ak47PlayerModel(
      id: map['id'] as String,
  ...
  @override
  String toString() {
    return 'Ak47PlayerModel(cards: $cards, index: $index, isShot: $isShot, cardsToTake: $cardsToTake)';
  }

  @override
  bool operator ==(covariant Ak47PlayerModel other) {
