...
class KrusaidPlayedCardsWidget extends HookConsumerWidget {
  const KrusaidPlayedCardsWidget({
    super.key,
              ...
              return Stack(
                ...
                children: [
                  if (playedCards.isEmpty)
                    AspectRatio(
                      aspectRatio: KrusaidUtils.playingCardAspectRatio,
                      child: Padding(
...
class KrusaidDeckWidget extends HookConsumerWidget {
  const KrusaidDeckWidget({super.key, required this.deck});
